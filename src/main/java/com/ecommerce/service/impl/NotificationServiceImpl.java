...
//	For add notification
	...
	public Map<String, Object> getAllNotification(Integer page, Integer size, String sort,
		...
		List<NotificationResponse> notificationResponses = notificationSet.getContent().stream()
				.map(notifications -> notificationToNotificationResponse(notifications)).collect(Collectors.toList());
