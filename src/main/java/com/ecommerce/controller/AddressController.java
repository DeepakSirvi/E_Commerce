...
@GetMapping("/{id}")
public ResponseEntity<AddressResponse> getByAddressid(@PathVariable long id){
...
public ResponseEntity<List<AddressResponse>>findStatusByUserId(@PathVariable long id){
